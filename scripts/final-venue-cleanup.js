// Final venue cleanup: Remove Cape Town venues and add Capricorn venues
...
// Capricorn District venues data with correct field names
...
async function finalVenueCleanup() {
  console.log('🧹 STARTING FINAL VENUE CLEANUP...')
  ...
  try {
    ...
    console.log('✅ FINAL VENUE CLEANUP FINISHED!')
